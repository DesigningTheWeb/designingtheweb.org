...
|---------------------|---------------------------------|-------------------|-----------------------|----------------------------------------|
| A                   | All completed                  | Average ≥ 90%    | 6 completed        | 1 completed                            |
| A-                  | All completed                  | Average ≥ 85%    | 6 completed         | 1 completed                            |
| B+                  | All completed                  | Average ≥ 80%    | 5 completed         | 1 completed                            |
| B                   | All completed                  | Average ≥ 75%    | 5 completed         | 1 completed                            |
| B-                  | All completed                  | Average ≥ 70%    | 5 completed         | 1 completed                            |
| C+                  | All completed                  | Average ≥ 65%    | 4 completed         | 1 completed                            |
| C                   | All completed                  | Average ≥ 60%    | 4 completed         | 1 completed                            |
| C-                  | 2 completed                    | Average ≥ 55%    | 4 completed         | 0 completed                            |
| D                   | 2 completed                    | Average ≥ 50%    | 3 completed         | 0 completed                            |
...
One presentation that demonstrates International & Intercultural Perspectives of web design. 
...
There are three required projects: course website, personal website, community project (introduced in this order). Course web and community web projects are completed in teams. Personal website project is completed individually. Projects are graded on a Pass/Fail basis. All three software portfolio projects have scaffolded tasks and deadlines throughout the semester, and require engagement in a standard software engineering process.
 ...
 If you do not contribute equitably to team projects — for example, if your team completes the project but your role was minimal — the project may still count as "completed" with a course grade reduction of up to one full letter (e.g., A to B or B+ to C+), depending on the extent of under-contribution. This determination will be based on: team feedback, observable contributions (e.g., PRs, commits), communication and engagement during the project.

To request an early assessment of any of your projects, please submit a request via [this form](https://forms.gle/4XTRoSCYaHeavBk79). I will check it, provide feedback on your project and if it does not meet some of the requirements, specify those improvements that need to be made before project passes.
...
[Tokens](https://forms.gle/MbV2iXiojrezyRE48) may be used for these assignments as described in the department's policy with the exception of the final submission of the web portfolio. A token can be requested *at any point* during the semester. The assignment for which the token is used can then be submitted at any point of the semester, but no later than the last day of classes.

At most two extra tokens may be earned by doing the following: 
1. participate in two events related to CIS and/or participate in the hackathon (must contribute to a project) 
AND 
2. submit reflection using this [Extra Token Request Form](https://forms.gle/bTsNHLqsZMiTjjqB6).
